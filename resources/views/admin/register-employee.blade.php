<x-layouts::auth>
    ...
    <div class="fixed inset-0 flex flex-col items-center justify-center bg-[#0C4D8B] z-50 font-['Source_Sans_3'] overflow-y-auto py-8">
        ...
        <div class="w-full max-w-5xl mx-auto flex flex-row justify-center gap-8">
            ...
            <div class="w-full max-w-[440px] flex flex-col bg-[#072b4e] px-10 py-10 rounded-[1.5rem] shadow-2xl border border-white/5 shrink-0">
                <div class="w-full text-center mb-8">
                    <h2 class="text-white !text-[1.4rem] font-semibold tracking-wide">Crear cuenta Empleado</h2>
                </div>
                <form method="POST" action="{{ route('admin.register-employee.store') }}" class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" name="name" placeholder="Nombre Completo" required value="{{ old('name') }}"
                            class="w-full bg-[#3B4B5B] text-white border-none rounded-full py-3 px-6 focus:ring-2 focus:ring-[#02B48A] outline-none !text-[15px] placeholder:!text-[15px] transition-all">
                        @error('name')
                    ...
                    <div class="flex flex-col" x-data="{ show: false }">
                        ...
                        <div class="relative w-full">
                            <input :type="show ? 'text' : 'password'" name="password" placeholder="Contraseña" required
                                class="w-full bg-[#3B4B5B] text-white border-none rounded-full py-3 px-6 pr-12 focus:ring-2 focus:ring-[#02B48A] outline-none !text-[15px] placeholder:!text-[15px] transition-all">
                    ...
                    <button type="submit" class="w-full bg-[#02B48A] hover:bg-[#029A73] text-white font-medium py-3 rounded-full mt-2 transition-all shadow-lg active:scale-95 !text-[16px]">
                        Registrar Empleado
                    </button>

                    <a href="{{ route('admin.dashboard') }}" class="w-1/2 mx-auto text-center bg-[#02B48A] hover:bg-[#029A73] text-white font-medium py-2 rounded-full mt-3 transition-all shadow-lg active:scale-95 !text-[15px]">
                        Regresar
                    </a>
                </form>
            </div>
                        ...
                        <tr x-data="{ open: false }">
                            <td>
                                ...
                                <div x-show="open" x-cloak class="fixed inset-0 z-[60] flex items-center justify-center">
                                    ...
                                    <div class="relative bg-[#072b4e] w-[90%] max-w-xl rounded-[1.5rem] border border-white/10 p-8 mx-4">
                                        <h3 class="text-center text-red-500 font-extrabold text-2xl tracking-widest mb-4">PRECAUCIÓN !!</h3>
                                        <p class="text-center text-white/90 mb-6">¿Estás seguro de eliminar este empleado?</p>
                                        <div class="bg-[#4D647C] text-white/90 rounded-3xl p-6 mb-6">
