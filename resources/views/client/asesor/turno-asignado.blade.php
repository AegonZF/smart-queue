<x-nova>
    ...
    <div class="fixed inset-0 w-full h-full overflow-y-auto bg-[#0C4D8B] f5 552ont-['Source_Sans_3'] text-white z-50"
         x-data="{
             estimatedWait: 0,
             isNext: false,
             notified: false,
             ...
             counterLabel: @js($turn->serviceCounter->label),
             poll() {
                 fetch('{{ route('nova.turno.active') }}', { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
                     ...
                     .then(d => {
                         ...
                         if (d.is_next && !this.notified) {
                             ...
                             this.counterLabel = d.counter_label ?? this.counterLabel;
        ...
        >
            ...
            <span class="font-bold text-base leading-snug" x-text="'Es su turno, pasa con ' + counterLabel"></span>
        </div>
