    ...
    <div class="fixed inset-0 w-full h-full overflow-y-auto bg-[#0C4D8B] font-['Source_Sans_3'] text-white z-50">
        ...
        <main class="flex flex-col items-center mt-4 px-6 w-full">
            ...
            <div class="w-full flex justify-center mt-4 mb-20">
                <a href="{{ route('nova.index') }}" class="bg-[#02B48A] hover:bg-[#029672] transition-all duration-200 rounded-[2rem] p-6 w-full md:w-64 h-32 flex items-center justify-center text-center shadow-lg hover:scale-105 active:scale-95 border border-white/5">
